  ...
  return (
    <li key={game.title} className="relative w-full h-64 md:h-104 lg:h-128 2xl:h-176 overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4 bg-black bg-opacity-30 ">
        <h2 className="text-white text-3xl md:text-5xl font-bold mb-2 text-outline-large line-clamp-3 break-words mx-6 md:mx-10 lg:mx-20 xl:mx-28 2xl:mx-40 ">{game.title}</h2>
        <p className="text-white text-sm md:text-lg max-w-2xl mb-2 text-outline-small line-clamp-4 break-words mx-6 md:mx-10 lg:mx-20 xl:mx-28 2xl:mx-40 ">{game.pannelDescription}</p>
